...
public class SwaggerConfig {
	...
	private ApiKey apiKeys() {
		...
		return new ApiKey(AUTHORIZATION_NAME, AUTHORIZATION_HEADER, PASSAS);
	}
	...
	private List<SecurityReference> securityReference(){
		...
		return Arrays.asList(new SecurityReference(AUTHORIZATION_NAME, new AuthorizationScope[] {scopes}));
	}
